...
public class RecipeControllerIT {
    ...
    void shouldReturnGenericRecipeListByQuery() throws Exception {
        ...
        mockMvc.perform(getRequestBuilder)
                ...
                .andExpect(content().json("{\"results\":[{\"id\":108172,\"title\":\"Pizza\",\"image\":\"https://spoonacular.com/recipeImages/108172-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":1090114,\"title\":\"pizza\",\"image\":\"https://spoonacular.com/recipeImages/1090114-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":210327,\"title\":\"Pizza\",\"image\":\"https://spoonacular.com/recipeImages/210327-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":285752,\"title\":\"Pizza Mac\",\"image\":\"https://spoonacular.com/recipeImages/285752-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":569888,\"title\":\"Pizza Logs\",\"image\":\"https://spoonacular.com/recipeImages/569888-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":1157875,\"title\":\"Pizza Bars\",\"image\":\"https://spoonacular.com/recipeImages/1157875-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":182600,\"title\":\"Pizza Cups\",\"image\":\"https://spoonacular.com/recipeImages/182600-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":620737,\"title\":\"Pizza Maki\",\"image\":\"https://spoonacular.com/recipeImages/620737-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":1414949,\"title\":\"Pizza Ring\",\"image\":\"https://spoonacular.com/recipeImages/1414949-312x231.jpg\",\"imageType\":\"jpg\"},{\"id\":569777,\"title\":\"Pizza Cups\",\"image\":\"https://spoonacular.com/recipeImages/569777-312x231.jpg\",\"imageType\":\"jpg\"}]}"));
    }
    ...
    void shouldReturnGenericRecipeListByCalories() throws Exception {
        ...
        mockMvc.perform(getRequestBuilder)
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().json("{\"results\":[{\"id\":1093751,\"title\":\"Sam's Easy Choc-Chip Cookies\",\"image\":\"https://spoonacular.com/recipeImages/1093751-312x231.jpg\",\"imageType\":\"jpg\"}]}"));
    }
